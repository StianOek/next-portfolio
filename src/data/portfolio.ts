...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    description:
      "Smart kvitteringsløsning som kobler banker, regnskapssystemer og lojalitetsprogrammer i ett samlet økosystem.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Komplett dashboard for administrasjon og håndtering av digitale kvitteringer.",
    longDescription:
    ...
    images: [getScreenshotUrl("https://dashboard.zeipt.dev")],
    useDynamicScreenshot: true,
    features: [
  ...
  },
  {
    slug: "retro-games",
    title: "Retro Games",
    subtitle: "Markedsplass for retro spill og konsoll",
    description: "Kjøp og salg av retro spill og konsoll",
    longDescription:
      "Retro Games er et skoleprosjekt som i likhet til Finn.no gir brukere tilgang til kjøp og salg av spesifikt retro spill og konsoll. Appen er bygget som en kryssplattform-løsning med Vue, Ionic og Capacitor, og kan kjøres både som web-app og native app på iOS og Android.",
    url: "",
    tags: [
      "Vue",
      "Ionic",
    ...
    heroImage: "/retro_games_home.png",
    images: [],
    mobileImages: [
      "/retro_games_home.png",
      "/retro_games_login.png",
    ],
    features: [
      "Kjøp og salg av retro spill",
      "Søk og filtrering etter konsoll",
      "Brukerregistrering og innlogging",
      "Favorittliste",
      "Meldingssystem mellom kjøper og selger",
      "Kryssplattform (iOS, Android, Web)",
    ],
    technologies: {
      frontend: ["Vue", "Ionic", "TypeScript", "Capacitor"],
      backend: ["GraphQL", "Directus"],
      other: ["Vite", "ESLint", "Prettier"],
    },
    year: "2022 - 2023",
    role: "Frontend Developer",
  ...
  },
  {
    ...
    description:
      "Moderne kvitteringsvisning med detaljert informasjon og interaktiv design.",
    longDescription:
      "Zeipt Receipt View er en elegant og brukervennlig løsning for visning av digitale kvitteringer. Med et moderne design og interaktive elementer, presenteres all relevant informasjon på en oversiktlig måte. Løsningen støtter både desktop og mobil, og gir brukerne en sømløs opplevelse uansett enhet.",
    ...
    heroImage: getScreenshotUrl(
      "https://view.zeipt.dev/users/019e1c14-62a0-8010-81fc-c95f63d4f8ff/receipts/019e1c14-3735-8007-b2cb-bda56b1614f6",
    ),
    images: [
      getScreenshotUrl(
        "https://view.zeipt.dev/users/019e1c14-62a0-8010-81fc-c95f63d4f8ff/receipts/019e1c14-3735-8007-b2cb-bda56b1614f6",
      ...
      getScreenshotUrl(
        "https://view.zeipt.dev/users/019c052d-9486-8010-b4e7-66a5ce937580/receipts/019c052d-9486-8007-95a0-8496592d4928?email=sebastian%40zeipt.com",
      ),
    ],
    features: [
  ...
  },
  {
    ...
    description:
      "Lavterskel løpeklubb med fokus på løpeglede, fellesskap og kaffe etterpå.",
    longDescription:
...
export function getFeaturedPortfolioItems(): PortfolioItem[] {
  return portfolioItems.filter(
    (item) => item.slug === "zeipt" || item.slug === "ihlenslk",
  );
}

...
export default function PortfolioDetailPage() {
      ...
      <>
        ...
        <main className="min-h-screen bg-page pt-32 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-4">Portfolio-element ikke funnet</h1>
            <Link href="/portfolio">
  ...
  const displayImages = imageFilter === 'mobile' && portfolioItem.mobileImages 
    ? portfolioItem.mobileImages 
    : portfolioItem.images;

  // Check if portfolio item has mobile images
  const hasMobileImages = portfolioItem.mobileImages && portfolioItem.mobileImages.length > 0;

  // For gallery, show all images (don't skip first one for mobile since they're separate)
  const galleryImages = imageFilter === 'mobile' && portfolioItem.mobileImages
    ? portfolioItem.mobileImages // Show all mobile images
    : portfolioItem.images.slice(1); // Skip first desktop image (it's the hero)
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            <div className="relative w-full aspect-video rounded-xl overflow-hidden border" style={{ 
              ...
              {!loadedImages.has(portfolioItem.heroImage) && (
              ...
              <Image
                ...
                className={`object-cover ${
                  loadedImages.has(portfolioItem.heroImage) ? 'opacity-100' : 'opacity-0'
                } transition-opacity duration-500`}
                priority
                onLoad={() => handleImageLoad(portfolioItem.heroImage)}
              />
            </div>
          </motion.div>
          ...
          <div className="space-y-20">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <p className="text-base">{portfolioItem.year}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-base">{portfolioItem.role}</p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {[...portfolioItem.technologies.frontend, ...portfolioItem.technologies.backend, ...portfolioItem.technologies.other]
                    .slice(0, 5)
                    .map((tech, index) => (
            ...
            {/* Additional Images */}
            {(portfolioItem.images.length > 1 || hasMobileImages) && (
              <>
                <div className="w-full h-px" style={{ backgroundColor: 'var(--border)' }} />
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    {galleryImages.map((image, index) => (
                      ...
                      >
                        ...
                        <img
                          src={image}
                          alt={`${portfolioItem.title} ${imageFilter} screenshot ${index + 1}`}
